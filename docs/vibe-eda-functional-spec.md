...
### [MODAL-001] 리포팅 초안 생성 모달
- **Trigger**: [TMH-004] 리포팅 버튼
- **구성**: 헤더 + 셀 선택 리스트 + 액션 버튼

#### [MODAL-001-1] 헤더
- 제목: `FileText` + "리포팅 초안 생성"
- 부제: "포함할 셀을 선택하세요"
- 우측: `X` 닫기
...
### [MODAL-002] 리포트 생성 중 오버레이
- **표시 조건**: `generatingReport === true`
- 중앙 카드: 애니메이션 `pulse` 아이콘 + "리포팅 작성 중..." 

### [MODAL-003] 리포트 결과 모달
- 전체 화면급 (max-w-3xl, 전체 높이)
- 헤더: `FileText` + "리포팅 초안 (Markdown)" + 복사/닫기
- 본문: `<pre>` 태그로 Markdown 원본 표시
